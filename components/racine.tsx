    ...
    return (
        <div className="w-full max-w-md mx-auto">
            <SearchBox
                ...
                classNames={{
                    root: "w-full",
                    form: "relative flex items-center border-2 rounded-full overflow-hidden shadow-sm transition-all duration-300",
                    input: "flex-grow px-4 py-3 pr-14 outline-none text-gray-700 placeholder-gray-400",
                    submit: "absolute right-2 top-1/2 -translate-y-1/2 p-2 text-white rounded-full transition-colors duration-200 bg-yellow-300",
            ...
            <div className="bg-white rounded-2xl space-y-4">
                <SearchBox
                    classNames={{
                        ...
                        form: "relative flex items-center border-2 rounded-full overflow-hidden shadow-md transition-all duration-300",
                        input: "flex-grow px-4 py-3 pr-14 outline-none text-gray-700 placeholder-gray-400",
...
export default function Racine() {
    ...
    return (
        <SearchUIContext.Provider value={{ isOpen, setIsOpen }} >
            <div
                ref={containerRef}
                className="relative max-w-4xl mx-auto bg-white rounded-2xl shadow-lg backdrop-blur-sm mt-4 min-h-fit"
                style={{ borderColor: '#092c74' }}
            >
                <InstantSearch indexName="images" searchClient={typesenseInstantSearchAdapter.searchClient}>
                    <Configure hitsPerPage={6} />
